...
namespace WHS.Infrastructure.Migrations
{
    ...
    [Migration("20250330203409_update tabls modify relation with category")]
    partial class updatetablsmodifyrelationwithcategory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WHS.Domain.Entities.Code.Warehouse", b =>
                {
                    ...
                    b.Property<Guid>("DutyStationGUID1")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WHS.Domain.Entities.Shipment.ShipmentRequestMovement", b =>
                {
                    ...
                    b.Property<Guid>("ShipmentRequestGUID1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ShipmentRequestGUID1");
            ...
            modelBuilder.Entity("WHS.Domain.Entities.Code.Warehouse", b =>
                {
                    ...
                    b.HasOne("WHS.Domain.Entities.Code.DutyStation", "DutyStation")
                        .WithMany("Warehouses")
                        .HasForeignKey("DutyStationGUID1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WHS.Domain.Entities.Enntry.EntryMovement", b =>
                {
                    b.HasOne("WHS.Domain.Entities.Account.User", "User")
            ...
            modelBuilder.Entity("WHS.Domain.Entities.Release.ReleaseRequestMovement", b =>
                {
                    ...
                    b.HasOne("WHS.Domain.Entities.Account.User", "Users")
                        .WithMany("ReleaseRequestMovements")
            ...
            modelBuilder.Entity("WHS.Domain.Entities.Shipment.ShipmentRequestMovement", b =>
                {
                    ...
                    b.HasOne("WHS.Domain.Entities.Shipment.ShipmentRequest", "ShipmentRequest")
                        .WithMany()
                        .HasForeignKey("ShipmentRequestGUID1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
