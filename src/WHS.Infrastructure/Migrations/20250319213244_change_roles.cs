...
{
    /// <inheritdoc />
    public partial class fssfsdf : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryLocations", x => x.LocationId);
                    table.ForeignKey(
                        name: "FK_CountryLocations_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DutyStations", x => x.DutyStationId);
                    table.ForeignKey(
                        name: "FK_DutyStations_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "OrganizationId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DutyStationId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CountryLocationLocationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Warehouses_CountryLocations_CountryLocationLocationId",
                        column: x => x.CountryLocationLocationId,
                        principalTable: "CountryLocations",
                        principalColumn: "LocationId");
                    table.ForeignKey(
                        name: "FK_Warehouses_DutyStations_DutyStationId",
                        column: x => x.DutyStationId,
                        principalTable: "DutyStations",
                        principalColumn: "DutyStationId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryLocations_CountryId",
                table: "CountryLocations",
                column: "CountryId");

            migrationBuilder.CreateIndex(
                name: "IX_DutyStations_OrganizationId",
                table: "DutyStations",
                column: "OrganizationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_CountryLocationLocationId",
                table: "Warehouses",
                column: "CountryLocationLocationId");

            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_DutyStationId",
                table: "Warehouses",
