...
internal class old(DbContextOptions<WarehouseDbContext> options) : IdentityDbContext<User>(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CountryLocation>()
            .HasKey(cl => cl.LocationGUID);  // Define the primary key for CountryLocation
        ...
        modelBuilder.Entity<Warehouse>()
            ...
            .HasForeignKey(w => w.DutyStationGUID)
        ...
        modelBuilder.Entity<Warehouse>()
              .HasOne(w => w.UserCreator)  // One-to-one relationship with User
              .WithMany()  // A User can own many warehouses, but no reverse navigation property in User
              .HasForeignKey(w => w.CreatorId)  // Use OwnerUserId as the foreign key
        ...
        modelBuilder.Entity<WarehouseUser>()
            .HasKey(wfp => wfp.WarehouseUserGUID); // Define the primary key
        ...
        modelBuilder.Entity<WarehouseUser>()
            ...
            .HasForeignKey(wfp => wfp.WarehouseGUID) // Foreign Key is WarehouseId
            .OnDelete(DeleteBehavior.Cascade); // Define delete behavior

        modelBuilder.Entity<User>()
            .HasMany(o => o.CreatedWarehouses)
